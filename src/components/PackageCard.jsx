...
//       <div className="absolute -top-[20px] -right-[20px] bg-red-700 text-white font-bold italic rounded-full py-2 px-4 z-1">
//         PKR 2,90,000
//       </div>
//       <div className="overflow-hidden w-full h-[300px]">
//         <img
//           className="w-full h-[300px] object-cover rounded-lg group-hover:scale-[1.05] transition-all ease-in-out duration-700 overflow-hidden"
...
//         />
//       </div>
//       <div className="flex flex-col gap-[10px] py-[20px] px-3 ">
//         <p className="bg-gradient-to-r from-blue-500 via-blue-700 to-blue-950 bg-clip-text text-transparent font-black italic text-[22px] text-center">
//           Umrah Gold Package
//         </p>
//         <div className="flex justify-center gap-[20px] items-center bg-black py-2 text-white">
//           <p>10-march-2025</p>
//           <div className="flex items-center justify-center gap-[20px]">
//             <GrSync color="white" size={20} />
//           </div>
//           <p>30-march-2025</p>
//         </div>
...
//           <div className="flex items-center justify-center gap-[20px]">
//             <ImAirplane color="#1447e6" size={20} />
//             <IoIosDocument color="#1447e6" size={20} />
//             <ImSpoonKnife color="#1447e6" size={20} />
//             <FaBus color="#1447e6" size={20} />
//             <MdOutlineLocalHotel color="#1447e6" size={20} />
//             <FaGift color="#1447e6" size={20} />
//           </div>
//         </div>
//       </div>
//     </div>
